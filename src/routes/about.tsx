  ...
  return (
    <>
      <PageHero
        ...
        description={`${siteConfig.name} is a training and externship company focused on helping students build practical technical skills, work on external organization projects and become career ready.`}
        crumbs={[{ label: "About" }]}
      />
            ...
            <div className="min-w-0">
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
                <p>
                  ...
                  programme where students are assigned projects for external organizations.
                </p>
                <p>
            ...
            <div className="grid min-w-0 gap-5">
              <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  ...
                  demonstrable skills, experience with external organization projects and the confidence to apply for
                  technical roles.
                </p>
              </div>
              <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
        ...
        <div className="container mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <div className="mt-10 space-y-5 text-base leading-relaxed text-muted-foreground">
            ...
            <p>
              ...
              and giving students a external organization project environment through our externship programme.
            </p>
          </div>
